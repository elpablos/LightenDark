...
launcherCallback();},initiateAudit:function(target,categoryIds,progress,runImmediately,startedCallback,finishedCallback)
...
WebInspector.AuditLauncherView.AllCategoriesKey="__AllCategories";WebInspector.AuditLauncherView.prototype={targetAdded:function(target){},targetRemoved:function(target){},activeTargetChanged:function(target)
{this._target=target;},_resetResourceCount:function()
...
this._auditController.initiateAudit(this._target,catIds,this._progressIndicator,this._auditPresentStateElement.checked,onAuditStarted.bind(this),this._setAuditRunning.bind(this,false));},_stopAudit:function()
