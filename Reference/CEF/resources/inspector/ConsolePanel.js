...
parameters[i]=this._target.runtimeModel.createRemoteObject(parameters[i],this._target);else
...
var node=this._target.domModel.nodeForId(nodeId);var renderer=WebInspector.moduleManager.instance(WebInspector.Renderer,node);if(renderer)
...
{var option=this._executionContextSelector.selectedOption();return option?option._target:WebInspector.targetManager.activeTarget();},_completionsForTextPrompt:function(proxyElement,wordRange,force,completionsReadyCallback)
