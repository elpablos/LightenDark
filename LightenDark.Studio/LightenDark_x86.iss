...
#define MyAppVersion GetFileVersion(AddBackslash(SourcePath) + "bin\x86\Release\LightenDark.exe")

;AppID - unique ID!
AppId=8578b9fa-8c25-493c-9d7f-f0e294562804
AppName={#MyAppSetupName}
AppVersion={#MyAppVersion}
AppVerName={#MyAppSetupName}_{#MyAppVersion} (x86)
...
;AppSupportURL=http://...
;AppUpdatesURL=http://...
OutputBaseFilename={#MyAppSetupName}-{#MyAppVersion}x86
...
[Files]
; AppData
Source: bin\x86\Release\LightenDark.exe; DestDir: {app}; DestName: LightenDark.exe; Flags: overwritereadonly ignoreversion
Source: bin\x86\Release\LightenDark.exe.config; DestDir: {app}; DestName: LightenDark.exe.config; Flags: overwritereadonly ignoreversion
Source: bin\x86\Release\*.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion recursesubdirs
Source: bin\x86\Release\Data\*.*; DestDir: {app}\Data
; Cef
Source: bin\x86\Release\locales\*.*; DestDir: {app}\locales
Source: bin\x86\Release\*.pak; DestDir: {app}; Flags: overwritereadonly ignoreversion recursesubdirs
Source: bin\x86\Release\*.dat; DestDir: {app}; Flags: overwritereadonly ignoreversion recursesubdirs
Source: bin\x86\Release\natives_blob.bin; DestDir: {app}; DestName: natives_blob.bin; Flags: overwritereadonly ignoreversion
Source: bin\x86\Release\snapshot_blob.bin; DestDir: {app}; DestName: snapshot_blob.bin; Flags: overwritereadonly ignoreversion
Source: bin\x86\Release\CefSharp.BrowserSubprocess.exe; DestDir: {app}; DestName: CefSharp.BrowserSubprocess.exe; Flags: overwritereadonly ignoreversion
